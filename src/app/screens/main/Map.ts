...
export class Map {
	...
	private async createObjectCollider(object: any) {
	...
	private async createAnimatedObject(object: any, spriteSheet: any, _layer: any, index: number): Promise<void> {
		...
		const box = new Graphics()
			.rect(animatedSprite.x, animatedSprite.y, animatedSprite.width, animatedSprite.height)
